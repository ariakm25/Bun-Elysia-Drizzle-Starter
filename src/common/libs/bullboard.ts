...
export class BullBoardElysiaAdapter implements IServerAdapter {
  ...
  public setStaticPath(
    staticsRoute: string,
    staticsPath: string,
  ): BullBoardElysiaAdapter {
    this.statics = { route: staticsRoute, path: staticsPath };

    return this;
  }

  public setViewsPath(viewPath: string): BullBoardElysiaAdapter {
  ...
  public setApiRoutes(routes: AppControllerRoute[]): BullBoardElysiaAdapter {
  ...
  public setEntryRoute(routeDef: AppViewRoute): BullBoardElysiaAdapter {
    this.entryRoute = routeDef;

    return this;
  }

  public setQueues(bullBoardQueues: BullBoardQueues): BullBoardElysiaAdapter {
    this.bullBoardQueues = bullBoardQueues;
    return this;
  }

  public setUIConfig(config: UIConfig = {}): BullBoardElysiaAdapter {
